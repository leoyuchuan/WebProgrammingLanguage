...
abstract class News implements ActiveRecordInterface
{
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            if ($dt !== $this->date) {
                $this->date = $dt;
                $this->modifiedColumns[NewsTableMap::COL_DATE] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : NewsTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(NewsTableMap::COL_DATE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NewsTableMap::COL_DATE)) {
            $criteria->add(NewsTableMap::COL_DATE, $this->date);
        }
