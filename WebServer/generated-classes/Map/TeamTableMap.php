...
class TeamTableMap extends TableMap
{
     ...
     */
    const COL_TEAM_ID = 'TEAM.team_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('TeamId', 'Name', ),
        self::TYPE_CAMELNAME     => array('teamId', 'name', ),
        self::TYPE_COLNAME       => array(TeamTableMap::COL_TEAM_ID, TeamTableMap::COL_NAME, ),
        self::TYPE_FIELDNAME     => array('team_id', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('TeamId' => 0, 'Name' => 1, ),
        self::TYPE_CAMELNAME     => array('teamId' => 0, 'name' => 1, ),
        self::TYPE_COLNAME       => array(TeamTableMap::COL_TEAM_ID => 0, TeamTableMap::COL_NAME => 1, ),
        self::TYPE_FIELDNAME     => array('team_id' => 0, 'name' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('TeamId', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(TeamTableMap::COL_TEAM_ID);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(TeamTableMap::COL_TEAM_ID, (array) $values, Criteria::IN);
        }
