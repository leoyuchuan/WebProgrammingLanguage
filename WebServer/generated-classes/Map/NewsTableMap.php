...
class NewsTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('NewsId', 'Title', 'Content', 'Date', ),
        self::TYPE_CAMELNAME     => array('newsId', 'title', 'content', 'date', ),
        self::TYPE_COLNAME       => array(NewsTableMap::COL_NEWS_ID, NewsTableMap::COL_TITLE, NewsTableMap::COL_CONTENT, NewsTableMap::COL_DATE, ),
        self::TYPE_FIELDNAME     => array('news_id', 'title', 'content', 'date', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('NewsId' => 0, 'Title' => 1, 'Content' => 2, 'Date' => 3, ),
        self::TYPE_CAMELNAME     => array('newsId' => 0, 'title' => 1, 'content' => 2, 'date' => 3, ),
        self::TYPE_COLNAME       => array(NewsTableMap::COL_NEWS_ID => 0, NewsTableMap::COL_TITLE => 1, NewsTableMap::COL_CONTENT => 2, NewsTableMap::COL_DATE => 3, ),
        self::TYPE_FIELDNAME     => array('news_id' => 0, 'title' => 1, 'content' => 2, 'date' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('NewsId', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(NewsTableMap::COL_DATE);
        } else {
